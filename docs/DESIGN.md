...
이 시스템은 **경남 지방 강사 구인공고만** 다룬다. 부산·울산 지역과 대학 부설 평생교육원은 범위 밖이며
별도 프로젝트에서 관리한다 (2026-09-22 결정).

### 1.2 범위

| 구분 | 포함 | 제외 |
|---|---|---|
| 지역 | 경상남도 18개 시군, 근무지가 경남인 공고, 경남 소재 기관의 원격·출강 공고 | 부산·울산 |
| 기관 | 경남도청·시군청, 경남교육청·교육지원청, 경남 출자·출연기관, 중앙정부 산하 공공기관의 경남 소재 지사·캠퍼스, 민간 학원·문화센터·기업 | 개인 과외, 학생·수강생 모집, **대학 부설 평생교육원**(별도 프로젝트에서 관리) |
...
| `university` | 대학 (시간강사·채용공고) | 경상국립대, 창원대, 인제대의 시간강사·채용 공고. 대학 부설 평생교육원은 범위 밖 |
